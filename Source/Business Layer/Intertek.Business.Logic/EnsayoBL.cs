...
namespace Intertek.Business.Logic
{
    ...
    public class EnsayoBL : Singleton<EnsayoBL>, IBaseLogic<Ensayo>
    {
        private readonly IEnsayoRepository repository = new EnsayoRepository();

        #region Miembros de IBaseLogic<Ensayo>
        ...
        public int Update(Ensayo entity)
        {
            try
            {
